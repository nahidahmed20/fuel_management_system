            ...
            <div class="col-lg-12">
                ...
                <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-center mb-5"
                    ...
                    <h4 class="mb-3 mb-md-0 d-flex align-items-center">
                        <i class="fas fa-wallet me-2"></i> Loan Due — {{ ucfirst($type) }} Report
                    </h4>
                    <a href="{{ route('loan.due.report.pdf', $type) }}" 
                ...
                <div class="card mb-4 shadow-sm border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body bg-light">
                        <div class="d-flex flex-wrap justify-content-center gap-3">
                            <a href="{{ route('loan.due.report', 'today') }}"
                            ...
                            <a href="{{ route('loan.due.report', 'monthly') }}"
                            ...
                            <a href="{{ route('loan.due.report', 'yearly') }}"
                ...
                <div class="card mb-4">
                    <div class="card-header fw-bold" style="background: linear-gradient(to right, #17a2b8, #138496); color: white;">
                        <i class="fas fa-hand-holding-usd me-2"></i> Loan Due Records
                    </div>
                            ...
                            <tbody>
                                @forelse($dues as $loan)
                                    <tr>
                                        ...
                                        <td>{{ $loan->borrower->address ?? 'N/A' }}</td>
                                        <td>{{ number_format($loan->amount, 2) }}</td>
                                    </tr>
                                @empty
                                    <tfoot>
                                        <tr>
                                            <td colspan="5" class="text-center text-muted py-3">No loan dues found for this period.</td>
                                        </tr>
                                    </tfoot>
                                @endforelse
                            </tbody>
