    ...
    <div class="container-fluid py-4">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header-custom">
                <h4 class="mb-0"><i class="fas fa-boxes me-2"></i> Product Stock Report</h4>
            </div>
            ...
            <div class="card-body" id="reportTable">
                @include('reports.partials.product_stock_table', ['productStocks' => $productStocks])
            </div>
...
$(document).ready(function () {
    ...
    function loadData() {
        $.ajax({
            url: "{{ route('reports.product.stock') }}",
            data: {
