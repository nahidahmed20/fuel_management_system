...
@section('title', 'Mobile Sales Report')
    ...
    <div class="container-fluid py-4">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header-custom">
                <h4 class="mb-0"><i class="fas fa-mobile-alt me-2"></i> Mobile Sales Report</h4>
            </div>
            ...
            <div class="card-body" id="reportTable">
                @include('reports.partials.mobile_sales_table', ['mobileSales' => $mobileSales])
            </div>
...
$(document).ready(function () {
    ...
    function loadData() {
        $.ajax({
            url: "{{ route('reports.mobile.sales') }}",
            data: {
