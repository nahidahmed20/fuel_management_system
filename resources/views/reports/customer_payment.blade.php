    ...
    <div class="container-fluid py-4">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header-custom">
                <h4><i class="fas fa-hand-holding-usd me-2"></i> Customer Payment Report</h4>
            </div>
            ...
            <div class="card-body" id="reportTable">
                @include('reports.partials.customer_payment_table', ['customerPayments' => $customerPayments])
            </div>
...
$(document).ready(function() {
    ...
    function loadData() {
        $.ajax({
            url: "{{ route('reports.customer.payment') }}",
            data: {
