            ...
            <div class="col-lg-12">
                ...
                <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-center mb-5"
                    ...
                    <h4 class="mb-3 mb-md-0 d-flex align-items-center justify-content-center justify-content-md-start w-100 w-md-auto">
                        ...
                        Customer Payment — {{ ucfirst($type) }} Report
                    </h4>
                    <a href="{{ route('customer.payment.report.pdf', $type) }}" 
                ...
                <div class="card mb-4 shadow-sm border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body bg-light">
                        <div class="d-flex flex-wrap justify-content-center gap-3">
                            ...
                            <a href="{{ route('customer.payment.report', 'today') }}"
                            ...
                            <a href="{{ route('customer.payment.report', 'monthly') }}"
                            ...
                            <a href="{{ route('customer.payment.report', 'yearly') }}"
                ...
                <div class="card mb-4">
                    <div class="card-header fw-bold" style="background: linear-gradient(to right, #17a2b8, #138496); color: white;">
                        <i class="fas fa-money-check-alt me-2"></i> Customer Payments
                    </div>
                            ...
                            <tbody>
                                @foreach($payments as $pay)
                                    <tr>
                                        ...
                                        <td>{{ $pay->customer->name ?? 'N/A' }}</td>
                                        <td>{{ $pay->customer->mobile ?? 'N/A' }}</td>
                                        <td>{{ $pay->customer->address ?? 'N/A' }}</td>
