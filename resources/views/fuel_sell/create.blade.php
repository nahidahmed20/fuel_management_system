        ...
        <div class="row justify-content-center">
            <div class="col-sm-12">
                <div class="card shadow-lg mb-4 rounded-0">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap card-header-center-sm"
                        ...
                        <div class="header-title">
                            <h4 class="card-title mb-0">
                                <i class="bi bi-bag-fill me-2"></i> Fuel Sell (Liters)
                            </h4>
                        </div>
                    ...
                    {{-- Form --}}
                    <div class="card-body">
                        <form action="{{ route('fuel.sell.store') }}" method="POST">
                            @csrf
...
<script>
    $(document).ready(function () {
            ...
            if (nozzleId) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        quantity = quantity > 0 ? quantity.toFixed(3) : '0.00';
        ...
        function calculateTotalSell(quantity = null) {
            ...
            let totalSell = (quantity * sellingPrice).toFixed(3);
            let totalBuy = (quantity * buyingPrice).toFixed(3);
