        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card shadow-lg mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap" style="background: linear-gradient(45deg, #3a6186, #89253e); color: #fff;">
                        <h5 class="mb-0">
                        ...
                        <form action="{{ route('fuel.short.update', $fuelShort->id) }}" method="POST">
                            ...
                            <div class="mt-4 d-flex justify-content-start">
                                <button type="submit" class="btn text-white" style="background-color: #129990;">
                                    <i class="fas fa-save me-1"></i> Update Fuel Short
                                </button>
                            </div>
                        </form>
                    </div>
